...
inline half3 FresnelLerp2(half3 F0, half3 F90, half cosA)
{
	half invCosA = 1 - cosA;
#if defined(_FRESNEL_POW1)
	half t = invCosA;
#elif defined(_FRESNEL_POW2)
	half t = invCosA*invCosA;   
#elif defined(_FRESNEL_POW3)
	half t = invCosA*invCosA*invCosA;  
#elif defined(_FRESNEL_POW4)
	half t = invCosA*invCosA*invCosA*invCosA;
#else
	half t = invCosA*invCosA*invCosA*invCosA*invCosA;
#endif
	return lerp(F0, F90, t);
}

half3 _GlazeAdditiveColor;
half  _GlazeAdditive;
...
#   endif
    ...
    half3 grazingTerm = (_GlazeAdditive+saturate(smoothness + (1-oneMinusReflectivity)))*_GlazeAdditiveColor;
	half3 color = diffColor * (gi.diffuse + light.color * diffuseTerm)
		+specularTerm * light.color * FresnelTerm(specColor, lh)
		+ gi.specular *   FresnelLerp2(specColor, grazingTerm, nv);
    ...
    UnityLight light, UnityIndirect gi)
{
    ...
    half3 color =   (diffColor + specularTerm * specColor) * light.color * nl
                    ...
                    + surfaceReduction * gi.specular * FresnelLerp2(specColor, grazingTerm, nv);
